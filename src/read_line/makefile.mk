...
SRC_INTERNAL_READ_LINE	:= _utils.c ansi/_ansi.c _init.c history/history.c history/_load.c _read.c gnl/get_next_line.c gnl/interface.c gnl/get_next_line_utils.c 
