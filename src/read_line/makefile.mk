...
SRC_INTERNAL_READ_LINE	:= _utils.c ansi/_ansi.c history/_load.c history/history.c gnl/get_next_line.c gnl/interface.c gnl/get_next_line_utils.c _init.c _read.c dir/dir.c 
