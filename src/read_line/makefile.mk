...
SRC_INTERNAL_READ_LINE	:= ansi/_move.c ansi/_ansi.c history/_get.c history/_load.c history/history.c gnl/get_next_line_utils.c gnl/interface.c gnl/get_next_line.c _read_lines.c completions/_get.c completions/_add.c completions/_free.c completions/_tokenize.c completions/completions.c _prompt.c _init.c _utils.c _manager.c _read.c 
