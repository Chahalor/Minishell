...
SRC_INTERNAL_READ_LINE	:= history/_load.c history/history.c _utils.c ansi/_ansi.c _read.c _init.c gnl/get_next_line.c gnl/interface.c gnl/get_next_line_utils.c 
