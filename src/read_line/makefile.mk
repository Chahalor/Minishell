...
SRC_INTERNAL_READ_LINE	:= ansi/_ansi.c ansi/_move.c history/_load.c history/_get.c history/history.c gnl/get_next_line.c gnl/get_next_line_utils.c gnl/interface.c _init.c _read.c _read_lines.c _utils.c _manager.c completions/_free.c completions/_tokenize.c completions/_add.c completions/_get.c completions/completions.c _prompt.c 
