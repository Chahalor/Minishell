...
DIR_OBJ		:= .build
DIR_BONUS	:= 
INCLUDE_ALL	:=-Iglobal -I$(DIR_SRC)/args -I$(DIR_SRC)/builtin -I$(DIR_SRC)/env -I$(DIR_SRC)/exec -I$(DIR_SRC)/exit -I$(DIR_SRC)/ft_printf -I$(DIR_SRC)/manager -I$(DIR_SRC)/parser -I$(DIR_SRC)/read_line -I$(DIR_SRC)/signal -I$(DIR_SRC)/utils

_DEPS		:= $(_OBJ_ALL:.o=.d)

# Here we include all the makefile.mk files
include  src/args/makefile.mk src/builtin/makefile.mk src/env/makefile.mk src/exec/makefile.mk src/exit/makefile.mk src/ft_printf/makefile.mk src/manager/makefile.mk src/parser/makefile.mk src/read_line/makefile.mk src/signal/makefile.mk src/utils/makefile.mk
-include $(_DEPS)
