...
DIR_OBJ		:= .build
DIR_BONUS	:= 
INCLUDE_ALL	:=-Iglobal -I$(DIR_SRC)/exit -I$(DIR_SRC)/libft -I$(DIR_SRC)/memory-manager -I$(DIR_SRC)/parseur -I$(DIR_SRC)/prompte -I$(DIR_SRC)/read_line -I$(DIR_SRC)/signal -I$(DIR_SRC)/utils

DIR_LIBFT	:= 
LIBFT		:= #$(DIR_LIBFT)/libft.a

# Here we include all the makefile.mk files
include  src/exit/makefile.mk src/libft/makefile.mk src/memory-manager/makefile.mk src/parseur/makefile.mk src/prompte/makefile.mk src/read_line/makefile.mk src/signal/makefile.mk src/utils/makefile.mk
...
OBJ_ALL		:= $(OBJ_EXIT) $(OBJ_LIBFT) $(OBJ_MEMORY-MANAGER) $(OBJ_PARSEUR) $(OBJ_PROMPTE) $(OBJ_READ_LINE) $(OBJ_SIGNAL) $(OBJ_UTILS)
