...
DIR_OBJ		:= .build
DIR_BONUS	:= 
INCLUDE_ALL	:=-Iglobal -I$(DIR_SRC)/args -I$(DIR_SRC)/builtin -I$(DIR_SRC)/exec -I$(DIR_SRC)/exit -I$(DIR_SRC)/ft_printf -I$(DIR_SRC)/global-manager -I$(DIR_SRC)/lexer -I$(DIR_SRC)/manager -I$(DIR_SRC)/prompt -I$(DIR_SRC)/read_line -I$(DIR_SRC)/signal -I$(DIR_SRC)/utils
...
include  src/args/makefile.mk src/builtin/makefile.mk src/exec/makefile.mk src/exit/makefile.mk src/ft_printf/makefile.mk src/global-manager/makefile.mk src/lexer/makefile.mk src/manager/makefile.mk src/prompt/makefile.mk src/read_line/makefile.mk src/signal/makefile.mk src/utils/makefile.mk
-include $(DEPS)
...
OBJ_ALL		:= $(OBJ_ARGS) $(OBJ_BUILTIN) $(OBJ_EXEC) $(OBJ_EXIT) $(OBJ_FT_PRINTF) $(OBJ_GLOBAL-MANAGER) $(OBJ_LEXER) $(OBJ_MANAGER) $(OBJ_PROMPT) $(OBJ_READ_LINE) $(OBJ_SIGNAL) $(OBJ_UTILS)
